### Developed a basic HTTP server and client capable of handling concurrent requests using Python’s threading library.
### Implemented the server to parse GET requests, retrieve local files, and return appropriate HTTP status codes (200 OK, 404 Not Found).
